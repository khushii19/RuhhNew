...
export function CartBar() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(72px+env(safe-area-inset-bottom))] z-30 flex justify-center px-4 md:hidden">
      <Link
        href="/order"
        className="m-slide-up press pointer-events-auto flex w-full max-w-[640px] items-center justify-between rounded-[14px] bg-rose-deep py-3.5 pl-5 pr-4 text-[13.5px] text-white shadow-[0_16px_32px_-16px_rgba(155,75,107,0.7)] transition hover:brightness-105"
      >
