 ...
 * Keyed by category name; unknown categories get a soft brand mark. The art
 * is transparent: its tile supplies the themed ground.
 */
const MOTIF: Record<string, string> = {
  ...
  "Chocolate Barks":
    "<g transform='rotate(-8 200 150)'><rect x='118' y='92' width='164' height='120' rx='12' fill='#6B4423'/><g stroke='#4E3018' stroke-width='5'><line x1='159' y1='92' x2='159' y2='212'/><line x1='200' y1='92' x2='200' y2='212'/><line x1='241' y1='92' x2='241' y2='212'/><line x1='118' y1='152' x2='282' y2='152'/></g><circle cx='150' cy='86' r='11' fill='#C98A52'/><circle cx='250' cy='84' r='9' fill='#C98A52'/></g>",
  Tiramisu:
...
export function categoryArt(category: string | null | undefined): string {
  ...
  // Deliberately transparent. The tile that holds this art already carries a
  // themed background (bg-rose, bg-cream2, ...), so leaving the ground to CSS
  // is what lets the art follow light and dark. Baking a tint in here is what
  // used to put a lit mint panel on the dark page.
  const svg =
